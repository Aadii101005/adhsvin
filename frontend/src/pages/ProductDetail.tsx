...
import { Shield, Droplets, Leaf, Star, Check, Plus, Minus } from 'lucide-react'
  ...
  return (
    <div className="pt-28 pb-16 min-h-screen bg-slate-50">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 bg-white p-6 md:p-12 rounded-3xl shadow-sm border border-slate-100">
          <motion.div 
          ...
          >
            ...
            <h1 className="text-3xl md:text-5xl font-bold font-heading mb-4 text-slate-900">{product.name}</h1>
