    ...
    <div className="w-full bg-[#F7F7F5] min-h-screen text-[#1F2937] pt-28 sm:pt-32 pb-20 md:pb-24">
      <div className="container mx-auto px-4 sm:px-6 md:px-12">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-[1.1] mb-6 md:mb-8 tracking-tight text-[#1F2937]">
          ...
          <p className="text-base sm:text-lg md:text-xl text-[#6B7280] mb-10 md:mb-12 leading-relaxed font-light">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 text-[#1F2937]">Who We Are</h2>
          <p className="text-base sm:text-lg text-[#6B7280] mb-8 leading-relaxed font-light">
          ...
          <p className="text-base sm:text-lg text-[#6B7280] mb-6 leading-relaxed font-light">
